...
import { addFixture, listFixtures } from "@/server/guides/service";
...
export async function GET(_request: Request, context: RouteContext) {
  ...
  try {
    const fixtures = await listFixtures(guide, version);
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const fixture = await addFixture(guide, version, body);
