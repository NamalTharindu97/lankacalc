...
| `freelance-tax-estimate` | regulated | Server v1.0.0; business-tax tests | Spec is comparatively brief; no formal approval or explicit Golden Fixtures section | No | Formal legal/accounting approval and explicit independently derived golden section | R3 |
...
| `withholding-tax` | regulated | Server v1.0.0; business-tax tests | Spec is comparatively brief; no formal approval or explicit Golden Fixtures section | No | Formal WHT/AIT legal-accounting approval and explicit independently derived golden section | R3 |
