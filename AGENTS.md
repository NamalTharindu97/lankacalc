...
- `docs/Sri_Lanka_Web_Application_Service_Research.md` is the product source; `plan/LankaTools_Backend_Plan.md` is the backend blueprint.
...
- All documented calculators are long-term scope, but implementation follows the phases in `plan/LankaTools_Backend_Plan.md`; do not widen the active phase merely because the catalog is comprehensive.
